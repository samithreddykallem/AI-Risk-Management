...
class Settings(BaseModel):
    ...
    max_investigation_depth: int = Field(default=3, description="Maximum iterative follow-up depth for investigation loops")
    confidence_threshold: float = Field(default=0.8, description="Evidence confidence threshold to conclude an investigation (0.0 to 1.0)")
    max_hypotheses_per_run: int = Field(default=5, description="Maximum hypotheses generated per system audit")
